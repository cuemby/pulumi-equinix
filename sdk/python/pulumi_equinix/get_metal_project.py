...
__all__ = [
    'GetMetalProjectResult',
    'AwaitableGetMetalProjectResult',
    'get_metal_project',
    'get_metal_project_output',
]

@pulumi.output_type
class GetMetalProjectResult:
    """
    ...
    def bgp_configs(self) -> Sequence['outputs.GetMetalProjectBgpConfigResult']:
        """
...
class AwaitableGetMetalProjectResult(GetMetalProjectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMetalProjectResult(
...
def get_metal_project(name: Optional[str] = None,
                      project_id: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMetalProjectResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('equinix:index/getMetalProject:GetMetalProject', __args__, opts=opts, typ=GetMetalProjectResult).value

    return AwaitableGetMetalProjectResult(
...
@_utilities.lift_output_func(get_metal_project)
def get_metal_project_output(name: Optional[pulumi.Input[Optional[str]]] = None,
                             project_id: Optional[pulumi.Input[Optional[str]]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetMetalProjectResult]:
    """
    Use this datasource to retrieve attributes of the Project API resource.
