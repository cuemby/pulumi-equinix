...
__all__ = [
    'GetMetalOperatingSystemResult',
    'AwaitableGetMetalOperatingSystemResult',
    'get_metal_operating_system',
    'get_metal_operating_system_output',
]

@pulumi.output_type
class GetMetalOperatingSystemResult:
    """
...
class AwaitableGetMetalOperatingSystemResult(GetMetalOperatingSystemResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMetalOperatingSystemResult(
            distro=self.distro,
            id=self.id,
            name=self.name,
...
def get_metal_operating_system(distro: Optional[str] = None,
                               name: Optional[str] = None,
                               provisionable_on: Optional[str] = None,
                               version: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMetalOperatingSystemResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('equinix:index/getMetalOperatingSystem:GetMetalOperatingSystem', __args__, opts=opts, typ=GetMetalOperatingSystemResult).value

    return AwaitableGetMetalOperatingSystemResult(
...
@_utilities.lift_output_func(get_metal_operating_system)
def get_metal_operating_system_output(distro: Optional[pulumi.Input[Optional[str]]] = None,
                                      name: Optional[pulumi.Input[Optional[str]]] = None,
                                      provisionable_on: Optional[pulumi.Input[Optional[str]]] = None,
                                      version: Optional[pulumi.Input[Optional[str]]] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetMetalOperatingSystemResult]:
    """
    Use this data source to get Equinix Metal Operating System image.
