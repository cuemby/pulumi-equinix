...
__all__ = [
    'GetMetalPrecreatedIPBlockResult',
    'AwaitableGetMetalPrecreatedIPBlockResult',
    'get_metal_precreated_ip_block',
    'get_metal_precreated_ip_block_output',
]

@pulumi.output_type
class GetMetalPrecreatedIPBlockResult:
    """
...
class AwaitableGetMetalPrecreatedIPBlockResult(GetMetalPrecreatedIPBlockResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMetalPrecreatedIPBlockResult(
...
def get_metal_precreated_ip_block(address_family: Optional[int] = None,
                                  facility: Optional[str] = None,
                                  global_: Optional[bool] = None,
                                  metro: Optional[str] = None,
                                  project_id: Optional[str] = None,
                                  public: Optional[bool] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMetalPrecreatedIPBlockResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('equinix:index/getMetalPrecreatedIPBlock:GetMetalPrecreatedIPBlock', __args__, opts=opts, typ=GetMetalPrecreatedIPBlockResult).value

    return AwaitableGetMetalPrecreatedIPBlockResult(
...
@_utilities.lift_output_func(get_metal_precreated_ip_block)
def get_metal_precreated_ip_block_output(address_family: Optional[pulumi.Input[int]] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetMetalPrecreatedIPBlockResult]:
    """
    Use this data source to get CIDR expression for precreated IPv6 and IPv4 blocks in Equinix Metal.
    You can then use the cidrsubnet TF builtin function to derive subnets.
