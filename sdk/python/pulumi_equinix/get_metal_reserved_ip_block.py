...
__all__ = [
    'GetMetalReservedIPBlockResult',
    'AwaitableGetMetalReservedIPBlockResult',
    'get_metal_reserved_ip_block',
    'get_metal_reserved_ip_block_output',
]

@pulumi.output_type
class GetMetalReservedIPBlockResult:
    """
...
class AwaitableGetMetalReservedIPBlockResult(GetMetalReservedIPBlockResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMetalReservedIPBlockResult(
...
def get_metal_reserved_ip_block(id: Optional[str] = None,
                                ip_address: Optional[str] = None,
                                project_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMetalReservedIPBlockResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('equinix:index/getMetalReservedIPBlock:GetMetalReservedIPBlock', __args__, opts=opts, typ=GetMetalReservedIPBlockResult).value

    return AwaitableGetMetalReservedIPBlockResult(
...
@_utilities.lift_output_func(get_metal_reserved_ip_block)
def get_metal_reserved_ip_block_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                       ip_address: Optional[pulumi.Input[Optional[str]]] = None,
                                       project_id: Optional[pulumi.Input[Optional[str]]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetMetalReservedIPBlockResult]:
    """
    Use this data source to find IP address blocks in Equinix Metal. You can use IP address or a block
    ID for lookup.
