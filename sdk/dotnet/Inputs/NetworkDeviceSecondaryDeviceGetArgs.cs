...
namespace Cuemby.Equinix.Inputs
{
    ...
    public sealed class NetworkDeviceSecondaryDeviceGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("interfaces")]
        private InputList<Inputs.NetworkDeviceSecondaryDeviceInterfaceGetArgs>? _interfaces;

        /// <summary>
        /// List of device interfaces. See Interface Attribute below
        /// for more details.
        /// </summary>
        public InputList<Inputs.NetworkDeviceSecondaryDeviceInterfaceGetArgs> Interfaces
        {
            get => _interfaces ?? (_interfaces = new InputList<Inputs.NetworkDeviceSecondaryDeviceInterfaceGetArgs>());
        ...
        [Input("sshKey")]
        public Input<Inputs.NetworkDeviceSecondaryDeviceSshKeyGetArgs>? SshKey { get; set; }
        ...
        public NetworkDeviceSecondaryDeviceGetArgs()
        {
        }
    }
}
