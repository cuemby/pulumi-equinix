...
namespace Cuemby.Equinix.Inputs
{
    ...
    public sealed class NetworkDeviceClusterDetailsNode0Args : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.NetworkDeviceClusterDetailsNode0VendorConfigurationArgs>? VendorConfiguration { get; set; }

        public NetworkDeviceClusterDetailsNode0Args()
        {
        }
    }
}
