...
namespace Pulumi.Equinix.Inputs
{
    ...
    public sealed class ECXL2ConnectionSecondaryConnectionArgs : Pulumi.ResourceArgs
    {
        [Input("actions")]
        private InputList<Inputs.ECXL2ConnectionSecondaryConnectionActionArgs>? _actions;

        /// <summary>
        /// One or more pending actions to complete connection provisioning.
        /// </summary>
        public InputList<Inputs.ECXL2ConnectionSecondaryConnectionActionArgs> Actions
        {
            get => _actions ?? (_actions = new InputList<Inputs.ECXL2ConnectionSecondaryConnectionActionArgs>());
            set => _actions = value;
        }
        ...
        public ECXL2ConnectionSecondaryConnectionArgs()
        {
        }
    }
}
