...
namespace Pulumi.Equinix.Inputs
{
    ...
    public sealed class NetworkDeviceClusterDetailsNode1GetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.NetworkDeviceClusterDetailsNode1VendorConfigurationGetArgs>? VendorConfiguration { get; set; }

        public NetworkDeviceClusterDetailsNode1GetArgs()
        {
        }
    }
}
