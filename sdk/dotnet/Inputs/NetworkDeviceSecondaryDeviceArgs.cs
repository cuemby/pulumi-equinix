...
namespace Cuemby.Equinix.Inputs
{
    ...
    public sealed class NetworkDeviceSecondaryDeviceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("interfaces")]
        private InputList<Inputs.NetworkDeviceSecondaryDeviceInterfaceArgs>? _interfaces;

        /// <summary>
        /// List of device interfaces. See Interface Attribute below
        /// for more details.
        /// </summary>
        public InputList<Inputs.NetworkDeviceSecondaryDeviceInterfaceArgs> Interfaces
        {
            get => _interfaces ?? (_interfaces = new InputList<Inputs.NetworkDeviceSecondaryDeviceInterfaceArgs>());
        ...
        [Input("sshKey")]
        public Input<Inputs.NetworkDeviceSecondaryDeviceSshKeyArgs>? SshKey { get; set; }
        ...
        public NetworkDeviceSecondaryDeviceArgs()
        {
        }
    }
}
