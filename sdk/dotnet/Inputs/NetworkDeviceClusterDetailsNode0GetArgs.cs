...
namespace Cuemby.Equinix.Inputs
{
    ...
    public sealed class NetworkDeviceClusterDetailsNode0GetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.NetworkDeviceClusterDetailsNode0VendorConfigurationGetArgs>? VendorConfiguration { get; set; }

        public NetworkDeviceClusterDetailsNode0GetArgs()
        {
        }
    }
}
