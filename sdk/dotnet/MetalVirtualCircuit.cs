...
namespace Cuemby.Equinix
{
    ...
    /// ```
    /// </summary>
    [EquinixResourceType("equinix:index/metalVirtualCircuit:MetalVirtualCircuit")]
    public partial class MetalVirtualCircuit : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public MetalVirtualCircuit(string name, MetalVirtualCircuitArgs args, CustomResourceOptions? options = null)
            : base("equinix:index/metalVirtualCircuit:MetalVirtualCircuit", name, args ?? new MetalVirtualCircuitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetalVirtualCircuit(string name, Input<string> id, MetalVirtualCircuitState? state = null, CustomResourceOptions? options = null)
            : base("equinix:index/metalVirtualCircuit:MetalVirtualCircuit", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MetalVirtualCircuit Get(string name, Input<string> id, MetalVirtualCircuitState? state = null, CustomResourceOptions? options = null)
        {
            return new MetalVirtualCircuit(name, id, state, options);
        }
    }

    public sealed class MetalVirtualCircuitArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// UUID of Connection where the VC is scoped to.
        /// </summary>
        ...
        public MetalVirtualCircuitArgs()
        {
        }
    }

    public sealed class MetalVirtualCircuitState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// UUID of Connection where the VC is scoped to.
        /// </summary>
        ...
        public MetalVirtualCircuitState()
        {
        }
    }
}
