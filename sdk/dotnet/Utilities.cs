...
namespace Pulumi.Equinix
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Equinix.version.txt");
    ...
    internal sealed class EquinixResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public EquinixResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
