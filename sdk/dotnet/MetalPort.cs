...
namespace Pulumi.Equinix
{
    ...
    /// </summary>
    [EquinixResourceType("equinix:index/metalPort:MetalPort")]
    public partial class MetalPort : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public MetalPort(string name, MetalPortArgs args, CustomResourceOptions? options = null)
            : base("equinix:index/metalPort:MetalPort", name, args ?? new MetalPortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetalPort(string name, Input<string> id, MetalPortState? state = null, CustomResourceOptions? options = null)
            : base("equinix:index/metalPort:MetalPort", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MetalPort Get(string name, Input<string> id, MetalPortState? state = null, CustomResourceOptions? options = null)
        {
            return new MetalPort(name, id, state, options);
        }
    }

    public sealed class MetalPortArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the port should be bonded.
        /// </summary>
        ...
        public MetalPortArgs()
        {
        }
    }

    public sealed class MetalPortState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// UUID of the bond port.
        /// </summary>
