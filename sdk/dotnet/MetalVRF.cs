...
namespace Cuemby.Equinix
{
    ...
    /// ```
    /// </summary>
    [EquinixResourceType("equinix:index/metalVRF:MetalVRF")]
    public partial class MetalVRF : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public MetalVRF(string name, MetalVRFArgs args, CustomResourceOptions? options = null)
            : base("equinix:index/metalVRF:MetalVRF", name, args ?? new MetalVRFArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetalVRF(string name, Input<string> id, MetalVRFState? state = null, CustomResourceOptions? options = null)
            : base("equinix:index/metalVRF:MetalVRF", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MetalVRF Get(string name, Input<string> id, MetalVRFState? state = null, CustomResourceOptions? options = null)
        {
            return new MetalVRF(name, id, state, options);
        }
    }

    public sealed class MetalVRFArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Description of the VRF.
        /// </summary>
    ...
    public sealed class MetalVRFState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Description of the VRF.
        /// </summary>
