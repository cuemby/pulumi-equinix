...
namespace Cuemby.Equinix
{
    ...
    /// </summary>
    [EquinixResourceType("equinix:index/networkDevice:NetworkDevice")]
    public partial class NetworkDevice : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.NetworkDeviceClusterDetails?> ClusterDetails { get; private set; } = null!;
        ...
        /// </summary>
        [Output("interfaces")]
        public Output<ImmutableArray<Outputs.NetworkDeviceInterface>> Interfaces { get; private set; } = null!;
        ...
        public Output<Outputs.NetworkDeviceSecondaryDevice?> SecondaryDevice { get; private set; } = null!;
        ...
        /// </summary>
        [Output("sshKey")]
        public Output<Outputs.NetworkDeviceSshKey?> SshKey { get; private set; } = null!;
        ...
        public NetworkDevice(string name, NetworkDeviceArgs args, CustomResourceOptions? options = null)
            : base("equinix:index/networkDevice:NetworkDevice", name, args ?? new NetworkDeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkDevice(string name, Input<string> id, NetworkDeviceState? state = null, CustomResourceOptions? options = null)
            : base("equinix:index/networkDevice:NetworkDevice", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkDevice Get(string name, Input<string> id, NetworkDeviceState? state = null, CustomResourceOptions? options = null)
        {
            return new NetworkDevice(name, id, state, options);
        }
    }

    public sealed class NetworkDeviceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Billing account number for a device.
        /// </summary>
        ...
        public Input<Inputs.NetworkDeviceClusterDetailsArgs>? ClusterDetails { get; set; }
        ...
        public Input<Inputs.NetworkDeviceSecondaryDeviceArgs>? SecondaryDevice { get; set; }
        ...
        /// </summary>
        [Input("sshKey")]
        public Input<Inputs.NetworkDeviceSshKeyArgs>? SshKey { get; set; }
    ...
    public sealed class NetworkDeviceState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Billing account number for a device.
        /// </summary>
        ...
        /// </summary>
        [Input("clusterDetails")]
        public Input<Inputs.NetworkDeviceClusterDetailsGetArgs>? ClusterDetails { get; set; }
        ...
        [Input("interfaces")]
        private InputList<Inputs.NetworkDeviceInterfaceGetArgs>? _interfaces;

        /// <summary>
        /// List of device interfaces. See Interface Attribute below
        /// for more details.
        /// </summary>
        public InputList<Inputs.NetworkDeviceInterfaceGetArgs> Interfaces
        {
            get => _interfaces ?? (_interfaces = new InputList<Inputs.NetworkDeviceInterfaceGetArgs>());
        ...
        /// </summary>
        [Input("secondaryDevice")]
        public Input<Inputs.NetworkDeviceSecondaryDeviceGetArgs>? SecondaryDevice { get; set; }
        ...
        /// </summary>
        [Input("sshKey")]
        public Input<Inputs.NetworkDeviceSshKeyGetArgs>? SshKey { get; set; }
