...
namespace Pulumi.Equinix
{
    ...
    /// ```
    /// </summary>
    [EquinixResourceType("equinix:index/metalReservedIPBlock:MetalReservedIPBlock")]
    public partial class MetalReservedIPBlock : Pulumi.CustomResource
    {
        [Output("address")]
        ...
        public MetalReservedIPBlock(string name, MetalReservedIPBlockArgs args, CustomResourceOptions? options = null)
            : base("equinix:index/metalReservedIPBlock:MetalReservedIPBlock", name, args ?? new MetalReservedIPBlockArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetalReservedIPBlock(string name, Input<string> id, MetalReservedIPBlockState? state = null, CustomResourceOptions? options = null)
            : base("equinix:index/metalReservedIPBlock:MetalReservedIPBlock", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MetalReservedIPBlock Get(string name, Input<string> id, MetalReservedIPBlockState? state = null, CustomResourceOptions? options = null)
        {
            return new MetalReservedIPBlock(name, id, state, options);
        }
    }

    public sealed class MetalReservedIPBlockArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Only valid as an argument and required when `type` is `vrf`. The size of the network to reserve from an existing VRF ip_range. `cidr` can only be specified with `vrf_id`. Range is 22-31. Virtual Circuits require 30-31. Other VRF resources must use a CIDR in the 22-29 range.
        /// </summary>
        ...
        public MetalReservedIPBlockArgs()
        {
        }
    }

    public sealed class MetalReservedIPBlockState : Pulumi.ResourceArgs
    {
        [Input("address")]
        ...
        public MetalReservedIPBlockState()
        {
        }
    }
}
