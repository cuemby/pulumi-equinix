...
namespace Cuemby.Equinix
{
    ...
    /// </summary>
    [EquinixResourceType("equinix:index/metalBGPSession:MetalBGPSession")]
    public partial class MetalBGPSession : Pulumi.CustomResource
    {
        /// <summary>
        /// `ipv4` or `ipv6`.
        /// </summary>
        ...
        public MetalBGPSession(string name, MetalBGPSessionArgs args, CustomResourceOptions? options = null)
            : base("equinix:index/metalBGPSession:MetalBGPSession", name, args ?? new MetalBGPSessionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetalBGPSession(string name, Input<string> id, MetalBGPSessionState? state = null, CustomResourceOptions? options = null)
            : base("equinix:index/metalBGPSession:MetalBGPSession", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MetalBGPSession Get(string name, Input<string> id, MetalBGPSessionState? state = null, CustomResourceOptions? options = null)
        {
            return new MetalBGPSession(name, id, state, options);
        }
    }

    public sealed class MetalBGPSessionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// `ipv4` or `ipv6`.
        /// </summary>
        ...
        public MetalBGPSessionArgs()
        {
        }
    }

    public sealed class MetalBGPSessionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// `ipv4` or `ipv6`.
        /// </summary>
