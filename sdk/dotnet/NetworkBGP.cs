...
namespace Pulumi.Equinix
{
    ...
    /// ```
    /// </summary>
    [EquinixResourceType("equinix:index/networkBGP:NetworkBGP")]
    public partial class NetworkBGP : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public NetworkBGP(string name, NetworkBGPArgs args, CustomResourceOptions? options = null)
            : base("equinix:index/networkBGP:NetworkBGP", name, args ?? new NetworkBGPArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkBGP(string name, Input<string> id, NetworkBGPState? state = null, CustomResourceOptions? options = null)
            : base("equinix:index/networkBGP:NetworkBGP", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkBGP Get(string name, Input<string> id, NetworkBGPState? state = null, CustomResourceOptions? options = null)
        {
            return new NetworkBGP(name, id, state, options);
        }
    }

    public sealed class NetworkBGPArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// shared key used for BGP peer authentication.
        /// </summary>
        ...
        public NetworkBGPArgs()
        {
        }
    }

    public sealed class NetworkBGPState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// shared key used for BGP peer authentication.
        /// </summary>
