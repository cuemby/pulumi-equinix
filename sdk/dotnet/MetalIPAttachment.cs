...
namespace Cuemby.Equinix
{
    ...
    /// </summary>
    [EquinixResourceType("equinix:index/metalIPAttachment:MetalIPAttachment")]
    public partial class MetalIPAttachment : Pulumi.CustomResource
    {
        [Output("address")]
        ...
        public MetalIPAttachment(string name, MetalIPAttachmentArgs args, CustomResourceOptions? options = null)
            : base("equinix:index/metalIPAttachment:MetalIPAttachment", name, args ?? new MetalIPAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetalIPAttachment(string name, Input<string> id, MetalIPAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("equinix:index/metalIPAttachment:MetalIPAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MetalIPAttachment Get(string name, Input<string> id, MetalIPAttachmentState? state = null, CustomResourceOptions? options = null)
        {
            return new MetalIPAttachment(name, id, state, options);
        }
    }

    public sealed class MetalIPAttachmentArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// CIDR notation of subnet from block reserved in the same project
        /// and facility as the device.
        ...
        public MetalIPAttachmentArgs()
        {
        }
    }

    public sealed class MetalIPAttachmentState : Pulumi.ResourceArgs
    {
        [Input("address")]
