 ...
 * ```
 */
export class MetalDeviceNetworkType extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetalDeviceNetworkTypeState, opts?: pulumi.CustomResourceOptions): MetalDeviceNetworkType {
        return new MetalDeviceNetworkType(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'equinix:index/metalDeviceNetworkType:MetalDeviceNetworkType';

    /**
     * Returns true if the given object is an instance of MetalDeviceNetworkType.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MetalDeviceNetworkType {
    ...
    constructor(name: string, argsOrState?: MetalDeviceNetworkTypeArgs | MetalDeviceNetworkTypeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MetalDeviceNetworkTypeState | undefined;
            resourceInputs["deviceId"] = state ? state.deviceId : undefined;
            resourceInputs["type"] = state ? state.type : undefined;
        } else {
            const args = argsOrState as MetalDeviceNetworkTypeArgs | undefined;
