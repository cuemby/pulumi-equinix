 ...
 * ```
 */
export class MetalSpotMarketRequest extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetalSpotMarketRequestState, opts?: pulumi.CustomResourceOptions): MetalSpotMarketRequest {
        return new MetalSpotMarketRequest(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'equinix:index/metalSpotMarketRequest:MetalSpotMarketRequest';

    /**
     * Returns true if the given object is an instance of MetalSpotMarketRequest.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MetalSpotMarketRequest {
     ...
     */
    public readonly instanceParameters!: pulumi.Output<outputs.MetalSpotMarketRequestInstanceParameters>;
    /**
     ...
     */
    constructor(name: string, args: MetalSpotMarketRequestArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MetalSpotMarketRequestArgs | MetalSpotMarketRequestState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MetalSpotMarketRequestState | undefined;
            ...
            const args = argsOrState as MetalSpotMarketRequestArgs | undefined;
 ...
 */
export interface MetalSpotMarketRequestState {
    /**
     * Maximum number devices to be created.
     */
     ...
     * description in equinix.MetalDevice docs.
     */
    instanceParameters?: pulumi.Input<inputs.MetalSpotMarketRequestInstanceParameters>;
    /**
     * Maximum price user is willing to pay per hour per device.
     */
 ...
 */
export interface MetalSpotMarketRequestArgs {
    /**
     * Maximum number devices to be created.
     */
    devicesMax: pulumi.Input<number>;
