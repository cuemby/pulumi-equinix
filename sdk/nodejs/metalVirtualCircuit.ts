 ...
 * ```
 */
export class MetalVirtualCircuit extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetalVirtualCircuitState, opts?: pulumi.CustomResourceOptions): MetalVirtualCircuit {
        return new MetalVirtualCircuit(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'equinix:index/metalVirtualCircuit:MetalVirtualCircuit';

    /**
     * Returns true if the given object is an instance of MetalVirtualCircuit.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MetalVirtualCircuit {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MetalVirtualCircuit.__pulumiType;
    }
    ...
    /**
     * Create a MetalVirtualCircuit resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MetalVirtualCircuitArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MetalVirtualCircuitArgs | MetalVirtualCircuitState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MetalVirtualCircuitState | undefined;
            ...
            const args = argsOrState as MetalVirtualCircuitArgs | undefined;
        ...
        super(MetalVirtualCircuit.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface MetalVirtualCircuitState {
    /**
     * UUID of Connection where the VC is scoped to.
     */
 ...
 */
export interface MetalVirtualCircuitArgs {
    /**
     * UUID of Connection where the VC is scoped to.
     */
    connectionId: pulumi.Input<string>;
